...
public abstract class RefreshHorizontalAdapter<T> extends RecyclerView.Adapter {
    ...
    public RefreshHorizontalAdapter(Context context) {
        this(context, new ArrayList<T>());
    }

    public RefreshHorizontalAdapter(Context context, List<T> list) {
        mList = list;
        mContext = context;
