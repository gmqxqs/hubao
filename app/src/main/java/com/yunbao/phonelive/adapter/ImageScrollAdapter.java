...
public class ImageScrollAdapter extends RecyclerView.Adapter<ImageScrollAdapter.Vh> implements ItemSlideHelper.Callback {
    ...
    public ImageScrollAdapter(Context context, List<VideoBean> list, int curPosition) {
        mContext = context;
        mList = list;
