...
public class ImageScrollViewHolder extends AbsViewHolder implements
    ...
    public ImageScrollViewHolder(Context context, ViewGroup parentView, int position, String videoKey, int page) {
