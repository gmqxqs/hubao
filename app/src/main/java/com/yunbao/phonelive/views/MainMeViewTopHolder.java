...
public class MainMeViewTopHolder extends AbsMainChildTopViewHolder implements OnItemClickListener<UserItemBean>, View.OnClickListener {
    ...
    public MainMeViewTopHolder(Context context, ViewGroup parentView) {
